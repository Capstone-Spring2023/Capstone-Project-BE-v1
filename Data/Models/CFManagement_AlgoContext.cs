...
{
    public partial class CFManagement_AlgoContext : DbContext
    {
        public CFManagement_AlgoContext()
        {
        }

        public CFManagement_AlgoContext(DbContextOptions<CFManagement_AlgoContext> options)
            : base(options)
        {
        }
